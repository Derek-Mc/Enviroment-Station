...
public class HumidGraph extends Activity {
    int[] date;
    double[] humid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GraphView mygraph = (GraphView) findViewById(R.id.humidGraph);
        ...
        {
            mydata[x]=new DataPoint(date[x],humid[x]);
        }
        ...
        series.setOnDataPointTapListener(new OnDataPointTapListener() {
            ...
            public void onTap(Series series, DataPointInterface dataPoint) {
                Toast.makeText(HumidGraph.this, dataPoint.getY() + "%, " + (int) dataPoint.getX() + " hour(s) ago.", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_humid_graph, menu);
        return true;
    }
