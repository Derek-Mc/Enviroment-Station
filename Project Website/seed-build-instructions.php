		...
		<DIV ID="Wrapper">
			...
			<ARTICLE ID="Article_1">
				...
				<SECTION ID="Section_2">
					...
					<P><a href="http://www.amazon.ca/Arduino-A000066-Uno-R3-Microcontroller/dp/B008GRTSV6/ref=sr_1_1?ie=UTF8&qid=1449726852&sr=8-1&keywords=arduino+uno"target="_blank">Arduino Uno - $12.00</a>
				...
				<SECTION ID="Section_3">
					...
					<P>The time it would take to reproduce the project is a couple of hours if you follow the instructions
					below.  This is assuming that you have already all of the parts you need.  The shipping of the soil
					moisture sensor can take a few weeks but can be easily skipped over it until the part arrives.					
					</P>
				</SECTION>
				...
				<SECTION ID="Section_4">
					...
					(I chose to use seperate grounds for the pump and the sensors, to make use of the 2 ground pins.).
					  ...
					  <br>Because the light sensor does not return a value greater than 3V to the Arduino, connect the 3.3V pin to the AREF pin on the opposite side of the board.
				...
				<SECTION ID="Section_6">
					...
					is no shorts (There will be a very small resistance if there is a short).  After his is done,turn on the Pi
				...
				<SECTION ID="Section_8">
					...
					<P><a href="https://validator.w3.org/nu/?doc=http%3A%2F%2Fmunro.humber.ca%2F~mccd0236%2Fceng317%2Fseed-build-instructions.php">W3C Validation of this site.</a>
				</SECTION>
